                ...
                <div class="hero-layout-2">
                    ...
                    <div class="hero-content">
                        ...
                        <div class="section-title">
                            ...
                            <h1 class="text-anime-style-3">Build Your Brand </br><span>Grow Your Business</span></h1>
            ...
            <div class="row section-row align-items-center">
                <div class="col-lg-7 col-md-7">
                    ...
                    <div class="section-title">
                        ...
                        <h2 class="text-anime-style-3">Design, Develop & Deployment Services</h2>
                    </div>
                    <!-- Section Title End -->
                </div>
            ...
            <div class="row section-row align-items-center">
                <div class="col-lg-8 col-md-9">
                    ...
                    <div class="section-title">
                        ...
                        <h2 class="text-anime-style-3">From Idea to Finish <br> We Deliver Excellence</h2>
                    </div>
                    <!-- Section Title End -->
                </div>
			...
			<div class="row">
				<div class="col-lg-4 col-md-6">
					...
					<div class="blog-item wow fadeInUp" data-wow-delay="0.25s">
						...
						<div class="post-featured-image">
							<figure class="image-anime">
								<a href="#"><img src="{{asset('web/images/post-1.jpg')}}" alt=""></a>
							</figure>
						</div>
						<!-- Blog Image End -->
                ...
                <div class="col-lg-4 col-md-6">
					...
					<div class="blog-item wow fadeInUp" data-wow-delay="0.5s">
						...
						<div class="post-featured-image">
							<figure class="image-anime">
								<a href="#"><img src="{{asset('web/images/post-2.jpg')}}" alt=""></a>
							</figure>
						</div>
						<!-- Blog Image End -->
                ...
                <div class="col-lg-4 col-md-6">
					...
					<div class="blog-item wow fadeInUp" data-wow-delay="0.75s">
						...
						<div class="post-featured-image">
							<figure class="image-anime">
								<a href="#"><img src="{{asset('web/images/post-3.jpg')}}" alt=""></a>
							</figure>
						</div>
						<!-- Blog Image End -->
