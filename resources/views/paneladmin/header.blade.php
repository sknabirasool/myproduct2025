					...
					<div class="tab-content">
						...
						<div class="tab-pane fade show active" id="tab-home" role="tabpanel" aria-labelledby="home-tab">
							...
							<div class="tab-pane-header">
							  <a href="{{url('/sriram-consultancy-services-home')}}"><p style="font-size:13px">User : {{Auth::user()->name}} ({{Auth::user()->identity_number}})</p></a>
							...
							<div class="sidebarMenuScroll">
								<div class="sidebar-menu">
									<ul>
									<li>
										<a href="{{url('/add-services')}}" class="current-page">Add Services</a>
										</li>
										<li>
										...
										<li>
											<a href="{{url('/admin-my-clients')}}">Add Clients</a>
										</li>
										<li>
											<a href="{{url('/admin-my-clients-list')}}">Client List</a>
										</li>

										<li>
											<a href="{{url('/admin-final-project-reports')}}">Reports </a>
										</li>
						...
						<div class="tab-pane fade" id="tab-product" role="tabpanel" aria-labelledby="product-tab">
							...
							<div class="sidebarMenuScroll">
								<div class="sidebar-menu">
								   <ul>
                             <li class="list-heading" >Project Drawing</li>
                            <li>

                            <li>
                                <a href="products.html" >Contours</a>
                            </li>

                              <li>
                                <a href="products.html" >Servey Drawings</a>
                            </li>

                            <li>
                                <a href="products.html" >Structural Drawing</a>
                            </li>
                            <li>
                                <a href="add-product.html">PT</a>
                            </li>
                            <li>
                                <a href="orders.html">MEP</a>
                            </li>
                            <li>
                                <a href="customers-list.html">Landscaping</a>
                            </li>
                            <li>
                                <a href="products-reviews.html">Municipal Approval Drawing</a>
                            </li>
                              <li>
                                <a href="products-reviews.html">Miscellaneous Drawings</a>
                            </li>
                        </ul>
                        <ul>
                            <li class="list-heading">Architectural Drawing</li>
                            <li>
                                <a href="calendar-daygrid-view.html">Elerations</a>
                            </li>
                            <li>
                                <a href="calendar-list-view.html">Renders</a>
                            </li>
                            <!--<li>-->
						...
						<div class="tab-pane fade" id="tab-pages" role="tabpanel" aria-labelledby="pages-tab">
                            ...
                            <li>
                                <a href="{{url('/admin-add-document-category')}}" >Add Document Category</a>
                              </li>

                              <li>
                                <a href="{{url('/admin-document-category-list')}}" >Document Category List</a>
                              </li>

                             <li>
                                <a href="{{url('upload-project-documents')}}" >Upload Documents</a>
                              </li>


                            <li>
                                <a href="{{url('upload-project-documents-list')}}">Uploaded Documents List</a>
                            </li>

                            <!--<li>-->
                            <!--    <a href="{{url('subadmin-download-project-documents')}}">Download Documents</a>-->
                            <!--</li>-->

                            <li>
                                <a href="{{url('admin-category-download-documents')}}">Download Files </a>
                            </li>

                            <li>
                                <a href="{{url('admin-add-project-schdule-documents')}}">Add Project Schdule </a>
                            </li>

                             <li>
                                <a href="{{url('admin-add-project-schdule-documents-files-list')}}">Project Schdule Files </a>
                            </li>


                            <!--<li>-->
                            <!--    <a href="{{url('admin-event-schdule')}}">Event Schdule</a>-->
                            <!--</li>-->
						...
						<div class="tab-pane fade" id="tab-authentication" role="tabpanel" aria-labelledby="authentication-tab">
							...
							<div class="sidebarMenuScroll">
								<div class="sidebar-menu">
									<ul>
                                        <li>
											<a href="{{ url('/superadmin-create-sub-admin') }}">Add Employee</a>
										</li>
										...
										<li>
											<a href="{{ url('admin-Sub-Admin-login-users') }}">Employee List</a>
										</li>

										<li>
											<a href="{{ url('admin-create-project-for-checklist-users') }}">Add Project</a>
										</li>

										<li>
											<a href="{{ url('admin-Scs-project-list') }}">Project List</a>
										</li>
...
<!---------------------------------
    ...
    <?php if($authid==2){?>
        ...
        <div class="nav" role="tablist" aria-orientation="vertical">
            ...
            <!--  <a class="nav-link" id="components-tab" data-bs-toggle="tab" href="#tab-components" role="tab" aria-controls="tab-components" aria-selected="false">-->
            <!--    <i class="icon-box"></i>-->
            <!--    <span class="nav-link-text">CheckListRequests</span>-->
            <!--</a>-->


            <!--<a class="nav-link" id="product-tab" data-bs-toggle="tab" href="#tab-product" role="tab" aria-controls="tab-product" aria-selected="false">-->
            <!--    <i class="icon-layers2"></i>-->
            <!--    <span class="nav-link-text">Project Drawing</span>-->
            <!--</a>-->
        ...
        <?php if (auth()->check() && auth()->user()->id == $manager_user_id): ?>
                    <!-- Content visible only to the manager goes here -->
            <a class="nav-link" id="authentication-tab" data-bs-toggle="tab" href="#tab-authentication" role="tab" aria-controls="tab-authentication" aria-selected="false">
                <i class="icon-users"></i>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade show active" id="tab-home" role="tabpanel" aria-labelledby="home-tab">
               ...
               <a href="{{url('/admin-home')}}"><p style="font-size:13px">User : {{Auth::user()->name}} ({{Auth::user()->identity_number}})</p></a>
                ...
                <div class="sidebarMenuScroll">
                    <div class="sidebar-menu">
                        <ul>
                            ...
                            <!--<li class="list-heading"><a href="{{url('all-checklist-dashboard')}}">All CheckLists</a></li>-->

                            <!--<li>-->
                            <!--<li>-->
                            <!--    <a href="{{url('create-pcc-checklist')}}" class="current-page">PCC</a>-->
                            <!--</li>-->


                            <!--<li>-->
                            <!--    <a href="{{url('/admin-pre-footing-checklist')}}">Pre-Footing</a>-->
                            <!--</li>-->

                            <!--<li>-->
                            <!--    <a href="{{url('/admin-post-footing-checklist')}}">Post-Footing</a>-->
                            <!--</li>-->
                            <!--<li>-->
                            <!--    <a href="{{url('/admin-precheck-coloums-corewell-checklist')}}">PreCheck-Coloumns-CoreWell</a>-->
                            <!--</li>-->
                            <!--<li>-->
                            <!--    <a href="{{url('/admin-postcheck-coloums-corewell-checklist')}}">PostCheck-Coloumns-CoreWell</a>-->
                            <!--</li>-->
                            <!--<li>-->
                            <!--    <a href="{{url('/admin-pre-retaining-wall-checkist')}}">Pre-RW</a>-->
                            <!--</li>-->
                            <!--<li>-->
                            <!--    <a href="{{url('/admin-post-retaining-wall-checklist')}}">Post-RW</a>-->
                            <!--</li>-->

                            <!--<li>-->
                            <!--    <a href="{{url('/admin-formwork-footing-checklist')}}">Formwork-Footing</a>-->
                            <!--</li>-->

                            <!-- <li>-->
                            <!--    <a href="{{url('/admin-formwork-retaining-wall-checklist')}}">Formwork-RW</a>-->
                            <!--</li>-->

                            <!-- <li>-->
                            <!--    <a href="{{url('/admin-formwork-column-core-rw-checklist')}}">FW Column Core Wall Pedestal</a>-->
                            <!--</li>-->
                        ...
                        <ul>
                            ...
                            <li>
                             <li>
                                 <a href="{{url('admin-pcc-all-list')}}">Raised Checklists</a>
                            </li>
                             <li>
                                <a href="{{url('staff-checklist-request')}}" >Received Checklists </a>
                            </li>
                             <li>
                                 <a href="{{url('admin-approved-pcc-all-list')}}">Approved Checklists</a>
                            </li>
                             <li>
                                 <a href="{{url('admin-rejected-all-checklist')}}">Rejected Checklists</a>
                            </li>
  ...
  <!-- Components tab -->
            <div class="tab-pane fade" id="tab-components" role="tabpanel" aria-labelledby="components-tab">
                ...
                <div class="sidebarMenuScroll">
                    <div class="sidebar-menu">
                        <ul>
                            <li class="list-heading" >CheckList Requests</li>
                            <li>
                             <li>
                                <a href="{{url('staff-checklist-request')}}"   class="current-page">CheckList Requests</a>
                            </li>
                              <li>
                                <a href="{{url('staff-approved-pcc-checklist')}}" >Approved CheckList</a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="sidebar-menu">
                        <ul>
                            ...
                            <li>
                             ...
                             <li class="list-heading">
                              <u> Structural Drawings</u>
                            </li>

                            <?php if (auth()->check() && auth()->user()->id == $drawing_user_id): ?>
                            <li>
                                <a href="{{url('/create-admin-structural-drawings')}}">Add Structural Drawings </a>
                            </li>

                            <li>
                                <a href="{{url('/admin-structural-drawings-list')}}">Add List Of Drawings   </a>
                            </li>
                           <?php endif; ?>

                             <li>
                                <a href="{{url('/structural-drawings-list-for-users')}}">Structural Drawings List </a>
                            </li>
                ...
                <div class="sidebarMenuScroll">
                    <div class="sidebar-menu">
                        <ul>
                            ...
                            <!-- <li>-->
                            <!--    <a href="{{url('/admin-create-material-procurement')}}">Create Mat. Proc. Data</a>-->
                            <!--</li>-->

                            <!--<li>-->
                            <!--    <a href="{{url('/admin-material-procurement-data-list')}}">Mat.Proc.Data List</a>-->
                            <!--</li>-->

                            <li>
                                <a href="{{url('/admin-create-request-for-material-procurement')}}">Create Mat. Proc. Request</a>
                            </li>

                            <li>
                                <a href="{{url('/admin-all-raised-requests-for-material-procurement')}}">Mat. Proc. Request List </a>
                            </li>

                            <li>
                                <a href="{{url('/admin-all-received-requests-for-material-procurement')}}">Received Mat. Proc. Request List </a>
                            </li>

                            <li>
                                <a href="{{url('/admin-all-approved-requests-for-material-procurement')}}">Approved Mat. Proc. Request List </a>
                            </li>

                             <li>
                                <a href="{{url('/admin-all-approved-requests-genaerate-report')}}">Mat. Proc. Generate Report </a>
                            </li>

                            <!--<li>-->
                            <!--    <a href="{{url('/admin-all-rejected-requests-for-material-procurement')}}">Rejected Mat. Proc. Request List </a>-->
                            <!--</li>-->

                            <!--<li>-->
                            <!--    <a href="{{url('/admin-project-schdule-documents-side-menu')}}">Project Schdule Documents </a>-->
                            <!--</li>-->

                        </ul>

                        <ul>
                            <li class="list-heading">Material Procurement Inventory</li>
                            <li>
                                <a href="{{url('/admin-Material-Procurement-Inventory-File')}}">Create Procurement Inventory File</a>
                            </li>
                ...
                <div class="sidebarMenuScroll">
                    <div class="sidebar-menu">
                        <ul>
                            ...
                            <li>
                                <a href="{{ url('/admin-manager-under-employees-list') }}">My Employees</a>
                            </li>
                            ...
                            <!--<li>-->
                            <!--    <a href="{{ url('/add-subadmin') }}">Add Subadmin</a>-->
                            <!--</li>-->
                            <!--<li>-->
                            <!--    <a href="{{ url('/subadmin-list') }}">Subadmin List</a>-->
                            <!--</li>-->
                            <!--<li>-->
							...
							<div class="sidebarMenuScroll">
								<div class="sidebar-menu">
									<ul>
										...
										<li>
											<a href="{{url('/hr-post-job-details')}}">Post Job Details</a>
										</li>
											<li>
											<a href="{{url('/hr-job-details-list')}}">Job Details List</a>
										</li>
										<li>
											<a href="{{url('/hr-applications-list')}}">Applications List</a>
										</li>
									<!--	<li>-->
                            ...
                            <div class="search-container">
                                ...
                                <div class="ui fluid category search">
                                    <div class="ui icon input">
                                        ...
                                        || Lastlogin At: {{ optional(Auth::user())->last_login_at }} || IP Address : {{ optional(Auth::user())->last_login_ip }} Location: {{$country}}, {{$region}}, {{$city}} - {{$zipCode}}  </p></bold>
